/* =================================================================================
   ...
   v1.0.1 — Language selector dropdown with flag emojis

   Changes from v1.0.0:
     - Fix: [hidden] attribute respected on English quick-switch (CSS specificity)
     - Write selected locale to sessionStorage for root redirect persistence
...
class SgLocalePicker extends SgComponent {
    ...
    _navigateToLocale(code) {
        try { sessionStorage.setItem('sg-locale', code) } catch { /* ignore */ }
