 ...
 *   llm:request-chunk     — { accumulated } → updates streaming bubble
 *   llm:request-complete  — { content } → finalises assistant bubble
...
export class SgLlmChatHistory extends HTMLElement {
    ...
    _onRequestChunk(e) {
        ...
        if (this._streamingEl) {
            this._streamingEl.innerHTML = _mdToHtml(this._streamingText)
    ...
    _scrollToBottom() { const el = this._msgsEl(); if (el) el.scrollTop = el.scrollHeight; }
