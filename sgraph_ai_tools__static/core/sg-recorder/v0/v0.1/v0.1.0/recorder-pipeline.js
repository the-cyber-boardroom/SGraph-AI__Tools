...
export async function startPipeline() {
    ...
    // Armed, not live: everything between here and RECORD_START (screen picker,
    // getUserMedia, camera auto-exposure warm-up) is NOT being recorded. The UI
    // uses this to show a "preparing — don't speak yet" indicator.
    _dispatchOnWindow(SGA_RECORDER.RECORD_ARMED, { mode: config.mode });
