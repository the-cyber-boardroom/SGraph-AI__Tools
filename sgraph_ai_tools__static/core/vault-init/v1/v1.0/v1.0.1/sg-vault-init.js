/* =============================================================================
   ...
   v1.0.1 — Bootstrap a brand-new vault from scratch

   v1.0.1 changes:
     - Re-pinned onto vault-write v1.1.2 + vault-client v1.2.3.
     - No API change.
   ...
   Usage:
     import { createVault } from '/core/vault-init/v1/v1.0/v1.0.1/sg-vault-init.js'
