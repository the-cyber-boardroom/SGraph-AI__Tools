...
export function initApiPane(wrap) {
    ...
    devPanel.className = 'yp-dev-panel';
    ...
    tabBar.className = 'yp-dev-panel__tabs';
    devPanel.appendChild(tabBar);

    const content = document.createElement('div');
    content.className = 'yp-dev-panel__content';
    ...
    for (const t of DEV_TABS) {
        ...
        btn.type = 'button';
        btn.className = 'yp-dev-panel__tab' + (t.id === activeTab ? ' is-active' : '');
        ...
        pane.className = 'yp-dev-panel__pane';
    ...
    footer.className = 'yp-footer-bar';
    const inner = document.createElement('div');
    inner.className = 'yp-footer-bar__inner';
    inner.innerHTML = `
...
function _buildSkills() {
    ...
    wrap.className = 'yp-skills';
    for (const s of SKILLS) {
        const card = document.createElement('div');
        card.className = 'yp-skills__card';
        const hdr = document.createElement('div');
        hdr.className = 'yp-skills__header';
        hdr.innerHTML = `<span>${s.label}</span><span class="yp-skills__chev">▼ expand</span>`;
        const body = document.createElement('pre');
        body.className = 'yp-skills__body';
        body.textContent = 'Loading…';
        hdr.addEventListener('click', () => {
            const open = body.style.display === 'block';
            body.style.display = open ? 'none' : 'block';
            hdr.querySelector('.yp-skills__chev').textContent = open ? '▼ expand' : '▲ collapse';
