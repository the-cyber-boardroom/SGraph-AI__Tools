...
export class PipelineState {
   ...
   * Deck total is persisted to localStorage.
   *
  ...
  /**
   * Reset the deck cost total to zero and remove from localStorage.
   *
   * @returns {void}
   */
  resetDeckCost() {
  ...
  /**
   * Cumulative USD cost for this browser session.
   *
   * @returns {number}
   */
  ...
  /**
   * Cumulative USD cost across all sessions for this deck (localStorage-backed).
   *
   * @returns {number}
   */
