 ...
 *
 * v0.1.30: adds "API Explorer" tab to the left panel stack.
 *   Imports sg-tool-api-explorer component and mounts it in a new tab
 *   alongside the existing "Create" tab.
 *
 * @version 0.1.30
 */
...
const api = new SgToolApi({
    ...
    version:  { api: '0.1.0', ui: '0.1.30', content: '0.1.0' },
