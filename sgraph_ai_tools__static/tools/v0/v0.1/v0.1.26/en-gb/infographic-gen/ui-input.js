 ...
 *
 * Builds all DOM elements for the input panel: model picker, mode toggle,
 * templates row, main textarea, document drop zone, action bar, advanced section.
 *
 * Returns refs needed by the orchestrator and send interceptor.
 *
 * @version 0.1.26
 */
...
function buildInputPanel(leftPanel, prefs, savePrefs) {
    ...
    actionBar.appendChild(advancedToggle); actionBar.appendChild(stopBtn); actionBar.appendChild(sendBtn);
