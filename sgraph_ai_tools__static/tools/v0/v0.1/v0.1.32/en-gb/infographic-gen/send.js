 ...
 *
 * Changes from v0.1.31:
 *   - callId threading — generate() sets a UUID on the SEND event detail;
 *     send.js echoes it in GENERATION_COMPLETE/ERROR/CANCELLED detail so
 *     infographic-gen.js can match concurrent generate() Promises precisely
 *     (no longer relies on FIFO arrival order for correlation).
 *
 * @version 0.1.32
 */
