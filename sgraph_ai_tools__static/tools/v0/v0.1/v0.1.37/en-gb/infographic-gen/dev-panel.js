/**
 * Infographic Generator — collapsible dev panel + footer bar builder.
 *
 * Appends to layoutWrap (flex column): resize handle, collapsible dev panel
 * (Explorer / Console / Manifest / Skills tabs), and the always-visible footer
 * bar that toggles the panel. Skills tab renders markdown via markdown.js.
 *
 * Call buildDevPanel(layoutWrap) after appending the toolArea div.
 *
 * @module dev-panel
 * @version 0.1.37
 */
...
// ── CSS for the Skills markdown body (injected once) ─────────────────────────
 ...
 * to layoutWrap. Fully self-contained — no return value needed.
 *
