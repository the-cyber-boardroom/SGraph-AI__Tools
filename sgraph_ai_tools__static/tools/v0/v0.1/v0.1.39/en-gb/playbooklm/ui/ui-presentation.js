 ...
 *
 * Shows the "Generate Presentation" action. After generation, displays
 * the resulting presentation document in an editable textarea.
 *
 ...
 * @returns {void}
 */
export function buildPresentationPanel(container, state) {
  ...
  container.innerHTML = `
    <h2 class="plm-step-title">Step 2 — Presentation Strategy</h2>
