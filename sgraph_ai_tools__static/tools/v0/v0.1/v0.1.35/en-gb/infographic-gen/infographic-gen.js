 ...
 *
 * v0.1.35 — Resizable dev panel + separator
 *
 * Adds a drag handle between the tool area and the dev panel. Dragging up/down
 * resizes the panel. A teal accent line on the footerBar top border provides
 * clear visual separation when the panel is open. Default height bumped to 340px
 * so the Console's call button is fully visible.
 *
 * @version 0.1.35
 */
...
const api = new SgToolApi({
    ...
    version:  { api: '0.1.0', ui: '0.1.35', content: '0.1.0' },
