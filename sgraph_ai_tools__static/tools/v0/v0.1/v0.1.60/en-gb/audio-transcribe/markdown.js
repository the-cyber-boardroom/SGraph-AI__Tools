/**
 * Markdown → HTML renderer for the Skills dev-panel tab.
 * (Shared minimal renderer, mirrors the mermaid-diagrams / send-receive pattern.)
 * @module audio-transcribe/markdown
 */
