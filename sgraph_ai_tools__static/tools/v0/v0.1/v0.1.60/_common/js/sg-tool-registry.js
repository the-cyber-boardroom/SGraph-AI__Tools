/* =================================================================================
   ...
   v0.1.60 changes:
     - Added 'google-contacts' (added in v0.1.60) under Misc. Pure client-side
       reader for /people/me/connections via the Google People API. Built on
       two new shared core modules: sg-google-auth (GIS oauth2 token-client
       wrapper, reusable for any Google API scope) and sg-google-people
       (People API REST + Person normaliser).
   ================================================================================= */
...
const TOOL_SLUGS = [
    ...
    'youtube-editor', 'youtube-upload', 'sg-video-editor', 'heic-converter',
    // Vault & Send
    ...
    // Misc
    'speed-test', 'linkedin-publisher', 'google-contacts',
];
