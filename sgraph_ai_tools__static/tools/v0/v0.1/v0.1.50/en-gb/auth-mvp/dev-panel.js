/**
 * Auth MVP — dev panel (Skills / Explorer / Console / Manifest tabs + footer bar).
 * Adapted from infographic-gen v0.1.37 dev-panel.js pattern.
 *
 * @module dev-panel
 * @version 0.1.50
 */
...
export function buildDevPanel(layoutWrap) {
    ...
    footerInner.innerHTML = `
        ...
        <span style="font-weight:600;font-size:13px;">Auth MVP</span>
        <span style="color:#64748b;font-size:11px;font-family:'SF Mono',Monaco,monospace;">v0.1.50</span>
