...
export const SGA_RECORDER = Object.freeze({
    ...
    RECORD_ARMED:     'tool:record:armed',  // startRecording began — acquiring media / warming up camera; NOT live yet
    RECORD_START:     'tool:record:start',
    RECORD_PROGRESS:  'tool:record:progress',
    RECORD_PAUSE:     'tool:record:pause',
    RECORD_RESUME:    'tool:record:resume',
