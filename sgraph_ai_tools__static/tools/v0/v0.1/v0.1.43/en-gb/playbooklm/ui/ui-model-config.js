 ...
 *
 * Redesigned in v0.1.43: uses a <select> element with friendly labels
 * (grouped by provider) plus a "Custom model ID…" fallback text input.
 * Choices persist to localStorage under 'plm-model-config'.
 *
...
export function buildModelSelector(phase) {
  ...
  customInput.placeholder = 'e.g. openai/o3-mini';
