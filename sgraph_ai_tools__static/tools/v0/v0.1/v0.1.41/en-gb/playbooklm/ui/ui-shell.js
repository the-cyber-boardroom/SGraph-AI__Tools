/**
 * PlaybookLM — UI shell builder (v0.1.41).
 *
 * Sets up the sg-layout split panel with a custom stepper on the left and
 * results stack on the right. Wires the dev panel and connection bar.
 *
 ...
 * Restores a previously saved API key from sessionStorage on load,
 * and saves it back on a successful connect.
 *
