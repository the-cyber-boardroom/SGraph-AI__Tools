...
export function buildStorageMethods({ state }) {
    ...
    async function saveProject(params = {}) {
        ...
        try {
            ...
            // Re-sync the UNSAVED CHANGES banner for EVERY save path (button,
            // API, keyboard) — the button path updates its own notice, but an
            // API-driven save previously left a stale banner on screen.
            try {
